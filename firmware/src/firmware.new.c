...
/* <convert.py> comment start
//void enter_progmode (void);

<convert.py> comment end*/////unsigned char 
/* <convert.py> comment start
//void enter_progmode_hvp (void);

<convert.py> comment end*///void exit_progmode_hvp (void);
...
<convert.py> comment end*///void p16c_bulk_erase (void);
...
<convert.py> comment end*///void p18_send_cmd_payload (unsigned char cmd, unsigned int payload);
